...
public abstract class Primary extends Stat {
    //
    protected double base_modifier;
    protected double occupation_modifier;
    //
    protected void setBaseModifier(double value) {this.base_modifier = value;}
    protected void setOccupationModifier(double value) {this.occupation_modifier = value;}
    //
    public void calculate() {}
    public void calculate(int level) {setValue(occupation_modifier * base_modifier * level);}
